      ...
      <div class="container-fluid d-flex align-items-center justify-content-between">
        ...
        <nav id="navbar" class="navbar">
          <ul>
            ...
            <li class="dropdown megamenu"><a class="nav-link scrollto" href="{{ url('#features') }}"><span>Products</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
                <ul>
                  <li>
    ...
    <main id="main">
      ...
      <section id="about" class="about">
        <div class="container" data-aos="fade-up">
          ...
          <div class="row g-4 g-lg-5" data-aos="fade-up" data-aos-delay="200" style="min-height: 500px; overflow: hidden;">
            ...
            <!-- ======= Services Section ======= -->
            <section id="services" class="services" style="padding-top: 0">
                <div class="container" data-aos="fade-up">
      ...
      <section id="contact" class="contact">
        ...
        <div class="map">
          <iframe src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3582.4625851044184!2d91.76508667541232!3d26.116456177130814!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMjbCsDA2JzU5LjIiTiA5McKwNDYnMDMuNiJF!5e0!3m2!1sen!2sin!4v1691052033770!5m2!1sen!2sin" width="600" height="450" frameborder="0" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div><!-- End Google Maps -->
          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-md-6">
              <div class="footer-info">
                <h3>Brosy Industries</h3>
                <p>
                <b>Office Location:</b><br>
                  H/No. 10, Dr. B. Borooah Road, Ulubari, <br>
                  Guwahati, Kamrup(M), Assam, 781007<br><br>
                </p>
                <p>
                    <b>Factory Location:</b><br>
                    H/No. 10, Dr. B. Borooah Road, Ulubari, <br>
                    Guwahati, Kamrup(M), Assam, 781007<br><br>
