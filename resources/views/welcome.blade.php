      ...
      <div class="container-fluid d-flex align-items-center justify-content-between">
        ...
        <nav id="navbar" class="navbar">
          <ul>
            ...
            <li class="dropdown megamenu"><a href="{{ url('#features') }}"><span>Products</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
              <ul>
                <li>
      ...
      <section id="about" class="about">
        <div class="container" data-aos="fade-up">
          ...
          <div class="row g-4 g-lg-5" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="col-lg-5">
              <div class="about-img">
                <img src="{{ asset('assets/img/about.jpg') }}" class="img-fluid" alt="" style="height: 300px;">
              </div>
            </div>
        ...
        <div class="container" data-aos="zoom-out">
          ...
          <div class="row g-5">
            ...
            <div class="col-lg-8 col-md-6 content d-flex flex-column justify-content-center order-last order-md-first">
              ...
              <p> Transform your farming and aquaculture ventures with us. Take advantage of our exceptional products and expert knowledge to maximize your yields, minimize your efforts, and contribute to a greener tomorrow.</p>
          ...
          <div class="row g-0">
            ...
            <div class="col-lg-6">
              <div class="content d-flex flex-column justify-content-center h-100">
                ...
                <ul>
                  <li><i class="bi bi-check-circle"></i> Discover how our innovative aquacultural solutions promote sustainable practices, enhance aquatic environments, and ensure healthy yields.</li>
                  <li><i class="bi bi-check-circle"></i> Explore how our cutting-edge agricultural technologies empower farmers to optimize crop growth, conserve resources, and maximize productivity.</li>
                  <li><i class="bi bi-check-circle"></i> Hear from our satisfied customers who have achieved remarkable success with our products. Learn how our solutions have transformed their aquaculture and agriculture endeavors.</li>
                </ul>
              </div>
            </div>
          </div>
